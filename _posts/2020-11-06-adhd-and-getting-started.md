...
<p>This can be: <br><strong>- Making a mental note like 'I have free time in 2 days, I will clean the bathroom in 2 days.' / 'I don't have the energy right now, but in an hour, I will start the dishes.'</strong><br>I like this system because we're making a deal / contract with ourselves.  We are setting aside time to simply stop what we're doing or to set aside the persistent thoughts and knock out this task.</p>

<p>Of course it's easy to set a date then push it back.  Then a little further, then a liiittttllleeee further. Perfect, that's the date, we'll do the dishes in one hour, 3 days, and  2 years.  It takes practice to <em>make</em> the contract with yourself and a bit more practice to <em>actually</em> honor it.</p>

<p><strong>- Making a google calendar with a couple of extra notifications leading to the to timeframe</strong><br>I prefer this method to just marking a date on the calendar.  The notifications put the item in my sight multiple times (In case I forget or get distracted) and gets me thinking about what I have to do to get ready for it.  By default I make notifications for 1 week, 1 day, and 1 hour.  but If it's something really important, like an editors birthday or something I need to unsubscribe from, I'll have a notification a month out.</p>

<p>A marked calendar can be walked by or simply too plain to take notice of, leading us to forget the thing we scheduled.  we just make sure our phones aren't on silent or go too long without checking it.</p>

<p><strong>- Marking a physical calendar or a whiteboard</strong><br>Be warned, Some people equate a 'to do' list to a 'to do later' list.  But there is something to be said about the sensory actions of writing something out, seeing it written down, feeling the pen in our hand and being able to place the board in a visible spot all combine to help us remember the task or, at the very least, that something was written down. </p>

<p><strong>-Making a Reward system</strong><br>Reward systems can be pretty sweet and help establish patterns.  For example, I have to clean the litter box on Saturdays. Oliver, my editor's furry little butt-munch, doesn't even like me but that's my task.  I'll do the deed and then, after washing my hands, I reward myself by playing one of my games, guilt-free, for an hour.</p>
...
<p>Once we have a system in place, that's not going to be the end of it.  We'll have to be vigilant and adjust aspects of the system over time to refine it.  With these tools in our crime fighting arsenal, our tasks should be a little easier.</p>

<p>TL;DR</p>

<p>Small Victories, make slow progress and take time to reflect and appreciate the effort you made to motivate yourself to keep going.</p>

<p>Have some music to distract from the work, make a specific playlist to maximize the effect.</p>

<p>Set aside time specifically to clean and allow yourself to get into the mood to clean.</p>

<p>Set up a reward system for yourself to relax / enjoy some downtime after making good progress.</p>

<p>If it's going to suck, embrace the suck and find a way minimize your exposure to the suck.</p>
