...
One of my favorites is the 'Back Palm Vanish' (BPV).  It's simple, requires next to no setup, and is versatile enough to be used with dollars, cards, pretty much anything you can hide behind your hand.
...
Ultimately,  When done the first time, you have surprise on your side so it will have a pretty good impact if people are paying attention.  But, this being such a simple trick, there are 2 things to keep in mind:  1) It looks better when you snap the item out by quickly closing your hand.  If you do it slow, the audience will be able to see how it's done.2) Doing the trick more then once will allow the audience to figure it out.  Everyone will say "Do it, again", so be prepared to either teach the trick or have the smart ones figure it out. 

TL;DR

Hold your item (Card, folded dollar, etc) between your fore finger and your pinkie so the card is hidden when you hand is open.

Important: KEEP YOUR HAND RELAXED.  Your instinct will be to tighten your grip, doing so causes your item to shift out of your grip.

This is a fast trick, It looks better when done quickly.

This is a simple trick, doing it more then once will allow the audience to figure it out.
